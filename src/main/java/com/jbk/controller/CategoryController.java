...
public class CategoryController {
	...
	public Category getCategoryById(@PathVariable long categoryId) {
		...
		if (category != null) {
			...
			throw new ResourceNotExistsExceptions(
					"Category Not Exists With Id = " + categoryId + " : /get-category-by-id/" + categoryId);
		}
	...
	public Object deleteCategory(@PathVariable long categoryId) {
		...
		if (obj instanceof Integer) {
			...
			if (i == 1) {
				throw new ResourceNotExistsExceptions("Entered categoryId is not available in the list.");
			} else {
				throw new ResourceNotExistsExceptions("The Category list is empty.");
			}
		} else {
			return obj;
		}
	...
	public Category updateSupplier(@RequestBody Category category) {
		Category update = service.updateCategory(category);

		if (update != null) {
			return update;
		} else {
			throw new ResourceNotExistsExceptions("Category does not exists.");
		}
	}
}
